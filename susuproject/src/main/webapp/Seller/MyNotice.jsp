<%@page import="com.smhrd.modelDAO.NoticeDAO"%>
<%@page import="com.smhrd.modelDTO.NoticeDTO"%>
...
<%
	NoticeDTO ndto= new NoticeDTO(nickname);
	NoticeDAO ndao =new NoticeDAO();
    ArrayList<NoticeDTO> noticeList = ndao.showAllNotice(nickname);
%>
