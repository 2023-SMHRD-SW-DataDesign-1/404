...
<head>
    ...
    <title>나의 채널 메인</title>

    <!-- css 연결 -->
    <link rel="stylesheet" href="./MychannelMainStyle.css">
...
<%	
	FeedDTO fdto= new FeedDTO(nickname);
	FeedDAO fdao =new FeedDAO();
    ArrayList<FeedDTO> mfeed_list = fdao.showMyFeeds(nickname);
%>

        <div class="row">
        <% for(int i = 0 ; i<fdao.showMyFeeds(nickname).size();i++){%>
            <div class="col-lg-4">
                <div class="feed">
