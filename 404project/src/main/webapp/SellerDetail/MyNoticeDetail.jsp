...
<head>
    ...
    <title>나의 채널 공지사항 상세</title>

    <!-- css 연결 -->
    <link rel="stylesheet" href="./MyNoticeDetailStyle.css">
...
<header class="header">
                    ...
                    <div class="notice_title">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <!-- 수정 버튼 클릭 시 공지사항 업로드 페이지로 이동 -->
                                <a href="../Upload/NoticeUpload.jsp" id="editLink">수정</a>
    ...
    <script>
        ...
        // 수정 버튼 클릭 시 공지사항 편집 페이지로 이동
        // 전에 입력한 데이터가 넘어와야 함
        document.getElementById("editLink").addEventListener("click", function (event) {
            event.preventDefault(); // 기본 링크 동작 방지
            window.location.href = event.target.href; // NoticeUpload.jsp 페이지로 이동
        });
