...
<body>
				...
				<div class="feed_name">
					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="../Upload/FeedUpload.jsp" id="editLink">수정</a> <a
								href="../Upload/ItemUpload.jsp" id="ItemLink">판매</a>
	...
	<script>
		...
		document.querySelector(".vertical-ellipsis").addEventListener(
				"click",
				function() {
					document.querySelector(".dropdown-content").classList
							.toggle("show");
				});
