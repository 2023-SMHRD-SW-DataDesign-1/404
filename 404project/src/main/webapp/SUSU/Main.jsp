		...
		<c:forEach begin="1" , end="100">
			<div class="main_feed">
				...
				<div class="profile">
					...
					<a href="../Channel/ChannelMain.jsp"> <img id="profile-img" src="../img/profile_img.png" alt="프로필 사진"> 
						<span class="nickname">${lfeed_list.nickname}</span>
					</a>
				</div>
				...
				<div class="feed-img">
					...
					<img src="../img/${lfeed_list.feed_image1}.jpg" class="card-img-top" alt="피드 사진">
					</a>
				</div>
						...
						<div class="item_link">
							...
							<div class="items">
								<div class="item">
									...
									<p><b>${productlink_list.product_price}</b></p>
                                                        </div>
                                 </a>
          ...
          </div> <!--main-feed(구독자순 정렬) 끝-->

     </c:forEach> <!--main-feed(구독자순 정렬) 반복 끝-->


   </div> <!--feed-container(피드 전체)-->
